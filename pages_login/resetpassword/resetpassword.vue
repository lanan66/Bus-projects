    ...
    <view class="content">
      ...
      <view class="con">
        ...
        <view class="input-item">
          <input type="text" placeholder="请输入手机号码" @input="NumInput" @blur="checkphone(phonevalue)"
            v-model.number="phonevalue">
        </view>
        <!-- 输入验证码 -->
        <view class="input-item">
          <input type="text" placeholder="短信验证码" @input="CodeInput" v-model="codevalue" @blur="checkcode(codevalue)">
        ...
        <!-- 输入密码 -->
        <view class="input-item">
          <input :type="isshowpaaward == true?'text':'password'" placeholder="输入新密码" @blur="checkpassword(passwordvalue)" v-model="passwordvalue">
          <!-- 关闭眼睛和开 -->
          <view class="eye">
        ...
        <!-- 再次输入密码 -->
        <view class="input-item">
          <input :type="isshowpaaward2 == true?'text':'password'" placeholder="再次输入新密码" @blur="checkpassword(passwordvalue2)" v-model="passwordvalue2">
          <!-- 关闭眼睛和开 -->
          <view class="eye">
            <image src="/static/image/login/nocansee.png" mode="" class="eye-icon"
              @click="isshowpaaward2 = !isshowpaaward2" v-show="isshowpaaward2 == 0"></image>
            <image src="/static/image/login/cansee.png" mode="" class="eye-icon"
              @click="isshowpaaward2 = !isshowpaaward2" v-show="isshowpaaward2 == 1"></image>
          </view>
        </view>
